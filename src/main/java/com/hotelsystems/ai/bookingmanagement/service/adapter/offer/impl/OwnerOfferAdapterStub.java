...
/**
 * Stub Owner Offer Adapter
 * 
 * Stub implementation for owner offer search and recheck.
 * This will be replaced by engineers with real owner inventory API integration.
 * 
 * Returns offers with source=OWNER, deterministic pricing.
 */
@Component
@RequiredArgsConstructor
@Slf4j
public class OwnerOfferAdapterStub implements OfferSearchAdapter, OfferRecheckAdapter {
    ...
    public List<OfferDto> searchOffers(
        ...
        log.info("STUB: Searching owner offers - hotelId: {}, checkIn: {}, checkOut: {}, guests: {}, rooms: {}",
        ...
        String offerId1 = "OWN-" + generateDeterministicId(hotelId + "-standard-" + checkIn + "-" + checkOut);
        ...
        // Offer 2: Suite (if nights >= 2)
        if (nights >= 2) {
            String offerId2 = "OWN-" + generateDeterministicId(hotelId + "-suite-" + checkIn + "-" + checkOut);
            BigDecimal suitePrice = basePrice.multiply(BigDecimal.valueOf(1.5)); // 50% more
            OfferDto offer2 = OfferDto.builder()
                    ...
                    .totalPrice(MoneyDto.builder()
                            ...
                            .currency("USD")
                            .build())
                    .cancellationPolicySummary("Free cancellation up to 72 hours before check-in")
                    .payload(createStubPayload("suite", suitePrice))
                    .build();
            offers.add(offer2);
        }
        
        log.info("STUB: Found {} owner offers", offers.size());
        return offers;
    }
    ...
    public OffersRecheckResponse recheck(
        ...
        log.info("STUB: Rechecking owner offer - offerId: {}, checkIn: {}, checkOut: {}",
        ...
        return OffersRecheckResponse.builder()
                ...
                .offer(updatedOffer)
                .message("STUB: Owner offer recheck successful")
                .build();
    }
    ...
    private BigDecimal calculateDeterministicPrice(String hotelId, long nights, int roomsCount) {
        // Deterministic: hash hotelId to get base price (owner prices typically lower)
        int hash = hotelId.hashCode();
        BigDecimal basePricePerNight = BigDecimal.valueOf(80 + (Math.abs(hash) % 150)); // $80-$230 per night
    ...
    private String extractHotelIdFromOfferId(String offerId) {
        ...
        if (offerId != null && offerId.startsWith("OWN-")) {
            return "HOTEL-OWNER-001"; // Default stub hotel
        }
        return "HOTEL-OWNER-001";
    }
