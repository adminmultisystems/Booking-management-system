...
/**
 * Stub implementation of Travellanda adapters for Phase-1.
 */
@Component
public class TravellandaStubAdapters implements SupplierOfferSearchAdapter, SupplierRecheckAdapter, SupplierBookingAdapter {
    ...
    public List<SupplierOfferDto> searchOffers(String hotelId, String supplierHotelId, 
        ...
        for (int i = 0; i < numOffers; i++) {
            ...
            offer.setOfferId("TL-OFFER-" + hotelId + "-" + checkIn + "-" + i);
            offer.setSupplierCode(SupplierCode.TRAVELLANDA);
            offer.setSupplierHotelId(supplierHotelId);
            offer.setRoomName("Deluxe Room " + (i + 1));
            offer.setBoard("Half Board");
            ...
            offer.setCancellationSummary("Free cancellation until 48 hours before check-in");
            
            TaxesAndFeesPlaceholderDto taxesAndFees = new TaxesAndFeesPlaceholderDto(
                    true, 
                    BigDecimal.valueOf(basePrice * 0.15), 
            ...
            try {
                String rawPayload = String.format(
                    "{\"supplier\":\"TRAVELLANDA\",\"hotelId\":\"%s\",\"checkIn\":\"%s\",\"checkOut\":\"%s\",\"price\":%s}",
    ...
    public SupplierBookResponse createBooking(String offerPayloadJson, String guestPayloadJson) {
        ...
        String supplierBookingRef = "TL-BOOK-" + shortRandom;
